...
imagestring($image, 5, 10, 10, 'Cours des actions Als', imagecolorallocate($image, 0, 255, 0));
imagestring($image, 5, 10, 30, 'et For en 2010', imagecolorallocate($image, 0, 255, 0));
...
$bdd = new PDO('pgsql:host=localhost;port=5432;dbname=grapheactions;', 'sebastien','');
